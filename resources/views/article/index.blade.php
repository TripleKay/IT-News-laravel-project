                    ...
                    <div class="d-flex justify-content-between">
                        <div class="">
                            ...
                            <a href="{{ route('article.index') }}" class="btn btn-lg btn-outline-dark mr-3">
                                ...
                                <span class="h5 mb-0">Search By : "{{ request()->search }}"</span>
                        ...
                        <form action="{{ route('article.index') }}" method="GET" class="mb-3">
                            ...
                            <div class="form-inline">
                                <input type="text" name="search" value="{{ request()->search }}" placeholder="search..."  class="form-control form-control-lg mr-2 " required>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     ...
                                     <form action="{{ route('article.destroy',[$article->id,'page'=>request()->page]) }}" method="POST" class="d-inline-block">
                                         @csrf
                                         @method('delete')
                                         <button class="btn btn-outline-danger" onclick="return confirm('Are you sure to delete this artilce?')">Delete</button>
                                     </form>
                                 </td>
                                 <td>
                                     <span class="small">
