<div class="col-12 col-lg-3 col-xl-2 vh-100 sidebar">
    ...
    <div class="nav-menu">
        <ul>
            ...
            <x-menu-item name="Manager Category" link="{{ route('category.index') }}" class="feather-layers" ></x-menu-item>
            <x-menu-item name="Create Article" link="{{ route('article.create') }}" class="feather-plus-circle" ></x-menu-item>
            <x-menu-item name="Article Lists" link="{{ route('article.index') }}" class="feather-list" ></x-menu-item>
